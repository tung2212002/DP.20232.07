...
public class HomeScreenHandler extends BaseScreenHandler implements Observer {
    ...
    // Common coupling: setupData() sử dụng global data ViewsConfig là
    // HOME_MEDIA_PATH
    @Override
    ...
    // Common coupling: aimsImage, cartImage sử dụng global data ViewsConfig là
    // CART_SCREEN_PATH
    @Override
    ...
    private void addMenuItem(int position, String text, MenuButton menuButton) {
        ...
        // Clean code: đang sử dụng trực tiếp 31, nên nên đặt thành biến hằng
    ...
    // Common coupling: cartInstance sử dụng global data SessionInformation là
    // cartInstance
    ...
    // Stamp coupling: redirectLoginScreen() truyền vào event, nhưng không sử dụng
    // đến
    // Common coupling: LoginScreenHandler sử dụng global data ViewsConfig là
    // LOGIN_SCREEN_PATH
    @FXML
